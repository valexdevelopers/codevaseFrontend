...
const SignUpForm = () => {
  ...
  return (
    <div className="loginFormWrap">
      {formResponse && (
        <Info status={formResponse.status} message={formResponse.message} />
      )}
        ...
        <div className="loginformContainer">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="formContainer">
              <label htmlFor="fullName" className="form-label loginFormLabel">
                Full Name
              </label>
              <input
                type="text"
            ...
            <div className="formContainer">
              <label htmlFor="email" className="form-label loginFormLabel">
                Email
              </label>
              <input
                type="email"
            ...
            <div className="formContainer">
              <label htmlFor="password" className="form-label loginFormLabel">
                Password
              </label>
            ...
            <div className="loginActionBtn">
              <div className="formButtons">
                <button type="submit" className="mb-1 with_bg with_radius">
                  Register
                </button>
              </div>
              <div className="formButtons">
