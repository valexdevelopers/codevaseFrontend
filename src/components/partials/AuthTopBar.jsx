...
function TopBar() {
    ...
    const [themesVisibility, setThemesVisibility] = useState(false);
        ...
        <div className="topBar">
            ...
            <div className="right_side_nav">
                ...
                <div className="drop_down_container">
                    <button type="button"
                        className="language_dropdown_btn"
                        onClick={(event) => setThemesVisibility((prevState) => !prevState)}
                    >
                        <span>Supported Themes</span>
                        {
                            themesVisibility ? <BIcons.CaretUpFill /> : <BIcons.CaretDownFill className="dropdown_carret" />
                        }


                    </button>
                    <div className={themesVisibility ? "language_dropdown show" : "language_dropdown hide"} >
                        <ul>
                            {langauages}
                        </ul>
                    </div>
